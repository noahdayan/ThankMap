 ...
 */
//Fill in the API keys below with your developer v2 keys.
static NSString * const kConsumerKey       = @"xDKix1XxEM3vRQwC8-OJHw";
static NSString * const kConsumerSecret    = @"tSdOZNasH1Cl3fry9oxooecmSfA";
static NSString * const kToken             = @"15p0yB6t4IIvMZ6vX-MOVr-tbxtWlrMn";
static NSString * const kTokenSecret       = @"4jfkGyjqjIq2kkXdXMOKw6yubQ4";
